...
using YapılacaklarListesi.Models;

namespace YapılacaklarListesi.Controllers
{
    public class BlogController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Baslik,Sehir,Resim,Icerik,CategoryId")] Blog blog)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Baslik,Sehir,Resim,Icerik,CategoryId")] Blog blog)
        {
            if (ModelState.IsValid)
            {
                blog.EklenmeTarihi = DateTime.Now;
